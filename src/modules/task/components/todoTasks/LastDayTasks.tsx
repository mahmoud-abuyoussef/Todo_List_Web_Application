...
import { Task } from "@/modules/task/types/taskType";
import { IoEllipsisHorizontalOutline } from "react-icons/io5";

export default function ToDayTodoTasks({ lastDayTasks }: { lastDayTasks: Task }) {
  const { image, title, description, priority, status, date } = lastDayTasks;
